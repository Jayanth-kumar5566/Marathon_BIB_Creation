...
def create(name1,name2,name3,name4,number):
    ...
    plt.text(80,380,str(number),color="white",fontsize=75,weight='heavy')
    plt.text(33,520,str(name1),color='black',fontsize=9.5,weight='bold')

    plt.text(912,380,str(number+1),color="white",fontsize=75,weight='heavy')
    plt.text(865,520,str(name2),color='black',fontsize=9.5,weight='bold')

    plt.text(80,930,str(number+2),color="white",fontsize=75,weight='heavy')
    plt.text(33,1065,str(name3),color='black',fontsize=9.5,weight='bold')

    plt.text(912,930,str(number+3),color="white",fontsize=75,weight='heavy')
